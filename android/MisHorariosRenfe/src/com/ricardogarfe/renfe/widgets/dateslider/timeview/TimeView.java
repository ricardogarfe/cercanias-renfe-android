...
package com.ricardogarfe.renfe.widgets.dateslider.timeview;
 ...
 * range of times (e.g. 1/1-1/31). The TimeView stores the range as well as a
 * string describing how to display itself.
 */
public interface TimeView {
     ...
     * 
     * @param to
     *            The TimeObject to use to populate this TimeView
     */
    public void setVals(TimeObject to);

    /**
     * Instructs this TimeView to copy its values from the specified TimeView,
     * so it will assume the state of the other TimeView.
     * 
     * @param other
     *            The TimeView to copy values from
     */
    public void setVals(TimeView other);

    /**
     * Get a string containing the textual representation of this TimeView's
     * time
     * 
     * @return
     */
