...
package com.ricardogarfe.renfe.widgets.dateslider;
...
public class ScrollLayout extends LinearLayout {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        rightShadow.setBounds(getScrollX() + getWidth() - 50, 0, getWidth()
                + getScrollX() + 1, getHeight());
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        case MotionEvent.ACTION_UP:
            ...
            int initialVelocity = (int) Math.min(
                    velocityTracker.getXVelocity(), mMaximumVelocity);
    ...
    private void fling(int velocityX) {
        if (getChildCount() > 0) {
            mScroller.fling(mScrollX, 0, velocityX, 0, Integer.MIN_VALUE,
