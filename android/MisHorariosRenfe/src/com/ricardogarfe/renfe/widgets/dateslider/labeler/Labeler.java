...
/**
 * This is an abstract class whose job is create TimeViews that can be used to
 * populate a ScrollLayout, and to generate TimeObjects from times that can be
 * used to populate the TimeViews.
 */
public abstract class Labeler {
    ...
    /**
     * @param viewWidthDB
     *            The default width of views labeled by this labeler in dp
     * @param viewHeightDB
    ...
    /**
     * Converts from a time to a TimeObject according to the rules of this
     * labeler.
     * 
     * @param time
     *            The time to display
     * @return the TimeObject representing "time" suitable for populating
     *         TimeViews returned from {@link #createView(Context, boolean)}
     */
    ...
    /**
     * Returns a new TimeView instance appropriate for population using
     * TimeObjects retrieved from {@link #getElem(long)}.
     * 
     * @param context
     * @param isCenterView
    ...
    /**
     * This method adds "val" time units (where a time unit is the amount of
     * time that separates one TimeView generated by this labeler from the next
     * -- e.g. if this labeler is producing TimeViews each representing a day,
     * then a time unit would be a single day) to the specified time and returns
     * a TimeObject representing the result.
     * 
     ...
     *            The time
     * @param val
     *            The number of units to add to the time
     * @return The resulting TimeObject
     */
    public abstract TimeObject add(long time, int val);

    /**
     * This method converts from a calendar to a TimeObject -- it does the
     * actual work of turning a point time into the range and display string
     * that componse a TimeObject.
     * 
     * @param c
     *            The time to convert
     * @return The resulting TimeObject
    ...
    /**
     * This method return the preferred width of TimeViews labeled by this
     * labeler.
     * 
     * @param context
    ...
    /**
     * This method sets a minute interval to only show multiples of this number
     * in any minute slider
     * 
     * @param minInterval
     */
