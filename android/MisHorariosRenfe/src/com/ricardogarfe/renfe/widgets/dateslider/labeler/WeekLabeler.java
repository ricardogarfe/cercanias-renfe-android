...
import com.ricardogarfe.renfe.widgets.dateslider.timeview.TimeTextView;
...
public class WeekLabeler extends Labeler {
    ...
    /**
     * We implement this as custom code rather than a method in Util because
     * there is no format string that shows the week of the year as an integer,
     * so we just format the week directly rather than extracting it from a
     * Calendar object.
     */
    @Override
    protected TimeObject timeObjectfromCalendar(Calendar c) {
        ...
        return new TimeObject(String.format(mFormatString, week), startTime,
                endTime);
    }
    ...
    /**
     * Here we define our Custom TimeTextView which will display the fonts in
     * its very own way.
     */
    private static class CustomTimeTextView extends TimeTextView {

        public CustomTimeTextView(Context context, boolean isCenterView,
                int textSize) {
            super(context, isCenterView, textSize);
        }

        /**
         * Here we set up the text characteristics for the TextView, i.e. red
         * colour, serif font and semi-transparent white background for the
         * centerView... and shadow!!!
         */
        @Override
